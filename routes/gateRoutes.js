...
const { generateMerchantBill } = require('./validationSchemas');
...
3. Make a POST req on https://fuse-backend-x7mr.onrender.com/gate/generate/bill ,with Body: {
"merchantId": "ID",
"amount": (Integer) > 0,
...
7. To check the bill status req GET on https://fuse-backend-x7mr.onrender.com/gate/check/:billID
